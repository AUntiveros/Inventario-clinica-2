...
app = Flask(__name__)
# Esto permite que tu app de Flutter (desde otro dominio) pueda hacer la petición
CORS(app) 
...
def generar_fallas_y_frecuencia(estado_equipos):
    fallas = []
    estado_map = {
        "muy bueno": (1, 3, "Cada 3 años"),
        "bueno": (3, 6, "Cada 2 años"),
        "mediano": (6, 9, "Anual"),
        "malo": (9, 12, "Cada 6 meses"),
        "muy malo": (12, 15, "Mensual")
    }
...
def generar_tiempos_uptime_downtime():
    ...
    downtime = round(random.uniform(50, 400), 2)
    return uptime, downtime

def obtener_costo_equipo(tipo_equipo):
    costos_base = {
        'Ventilador mecánico': (15000, 50000), 'Monitor multiparámetros': (8000, 25000), 'Bomba de infusión': (3000, 15000),
        'ECG portátil': (7000, 20000), 'Desfibrilador': (10000, 30000), 'Incubadora': (20000, 40000), 'Termómetro': (50, 150),
        'Oxímetro de pulso': (50, 250), 'Resonador magnético (RMN)': (700000, 1200000), 'Tomógrafo (CT)': (500000, 800000),
        'Rayos X': (100000, 300000), 'Mamógrafo': (100000, 200000), 'Endoscopio': (50000, 150000), 'Laparoscopia': (10000, 25000),
        'Analizador de gases en sangre': (20000, 70000), 'Microscopio': (1000, 5000), 'Centrífuga': (3000, 10000), 'Espectrómetro': (10000, 30000),
        'Sierra para huesos': (5000, 15000), 'Electrobisturíe': (10000, 30000), 'Bomba de infusión para cirugía': (5000, 20000),
        'Incubadora para neonatos': (30000, 60000), 'Monitor de presión intracraneal': (10000, 25000),
    }
...
# Toma tu lógica original y la convierte en una función que devuelve un DataFrame
def generar_inventario_dataframe(cantidad_equipos, estado_hospital, estado_equipos):
    equipos_base = {
        "muy bueno": {'Ventilador mecánico': 50, 'Monitor multiparámetros': 40, 'Bomba de infusión': 35, 'ECG portátil': 35, 'Desfibrilador': 25, 'Incubadora': 20, 'Termómetro': 60, 'Oxímetro de pulso': 55, 'Resonador magnético (RMN)': 3, 'Tomógrafo (CT)': 5, 'Rayos X': 7, 'Mamógrafo': 2, 'Endoscopio': 4, 'Laparoscopia': 3, 'Analizador de gases en sangre': 8, 'Microscopio': 8, 'Centrífuga': 8, 'Espectrómetro': 4, 'Sierra para huesos': 6, 'Electrobisturíe': 10, 'Bomba de infusión para cirugía': 6, 'Incubadora para neonatos': 10, 'Monitor de presión intracraneal': 3},
        "bueno": {'Ventilador mecánico': 45, 'Monitor multiparámetros': 40, 'Bomba de infusión': 30, 'ECG portátil': 30, 'Desfibrilador': 20, 'Incubadora': 15, 'Termómetro': 50, 'Oxímetro de pulso': 45, 'Resonador magnético (RMN)': 2, 'Tomógrafo (CT)': 3, 'Rayos X': 5, 'Mamógrafo': 1, 'Endoscopio': 3, 'Laparoscopia': 2, 'Analizador de gases en sangre': 6, 'Microscopio': 6, 'Centrífuga': 6, 'Espectrómetro': 3, 'Sierra para huesos': 5, 'Electrobisturíe': 8, 'Bomba de infusión para cirugía': 5, 'Incubadora para neonatos': 8, 'Monitor de presión intracraneal': 2},
        "mediano": {'Ventilador mecánico': 40, 'Monitor multiparámetros': 35, 'Bomba de infusión': 30, 'ECG portátil': 30, 'Desfibrilador': 20, 'Incubadora': 15, 'Termómetro': 50, 'Oxímetro de pulso': 45, 'Resonador magnético (RMN)': 2, 'Tomógrafo (CT)': 3, 'Rayos X': 4, 'Mamógrafo': 1, 'Endoscopio': 2, 'Laparoscopia': 2, 'Analizador de gases en sangre': 6, 'Microscopio': 6, 'Centrífuga': 6, 'Espectrómetro': 3, 'Sierra para huesos': 5, 'Electrobisturíe': 7, 'Bomba de infusión para cirugía': 5, 'Incubadora para neonatos': 7, 'Monitor de presión intracraneal': 3},
        "malo": {'Ventilador mecánico': 30, 'Monitor multiparámetros': 30, 'Bomba de infusión': 25, 'ECG portátil': 25, 'Desfibrilador': 15, 'Incubadora': 10, 'Termómetro': 40, 'Oxímetro de pulso': 35, 'Resonador magnético (RMN)': 2, 'Tomógrafo (CT)': 3, 'Rayos X': 4, 'Mamógrafo': 1, 'Endoscopio': 2, 'Laparoscopia': 2, 'Analizador de gases en sangre': 5, 'Microscopio': 5, 'Centrífuga': 5, 'Espectrómetro': 3, 'Sierra para huesos': 4, 'Electrobisturíe': 6, 'Bomba de infusión para cirugía': 4, 'Incubadora para neonatos': 6, 'Monitor de presión intracraneal': 2},
        "pesimo": {'Ventilador mecánico': 20, 'Monitor multiparámetros': 20, 'Bomba de infusión': 15, 'ECG portátil': 15, 'Desfibrilador': 10, 'Incubadora': 5, 'Termómetro': 30, 'Oxímetro de pulso': 25, 'Resonador magnético (RMN)': 1, 'Tomógrafo (CT)': 2, 'Rayos X': 3, 'Mamógrafo': 1, 'Endoscopio': 2, 'Laparoscopia': 2, 'Analizador de gases en sangre': 4, 'Microscopio': 4, 'Centrífuga': 4, 'Espectrómetro': 2, 'Sierra para huesos': 3, 'Electrobisturíe': 5, 'Bomba de infusión para cirugía': 3, 'Incubadora para neonatos': 5, 'Monitor de presión intracraneal': 2}
    }
    equipos_cantidades_ajustadas = equipos_base.get(estado_hospital, equipos_base["mediano"]).copy()

    equipos_restantes = cantidad_equipos - sum(equipos_cantidades_ajustadas.values())
    ...
    data_ajustada = []
    codigo = 1
    for equipo, distribucion in equipos_cantidades_ajustadas.items():
        for _ in range(distribucion):
            fallas, frecuencia = generar_fallas_y_frecuencia(estado_equipos)
            uptime, downtime_val = generar_tiempos_uptime_downtime()
            costo = obtener_costo_equipo(equipo)
            ...
            data_ajustada.append({
                'Código': f'ID{str(codigo).zfill(4)}',
                'Nombre': equipo,
                'Fecha Adquisición': fecha_adquisicion,
                'Frecuencia de Uso': random.choice(frecuencias_uso),
                'Fallas': "; ".join([str(f) for f in fallas]),
                'Frecuencia de Fallas': frecuencia,
                'Downtime': downtime_val, # Se usa el valor de la función
                'Tipo de Equipo': random.choice(tipos_equipo),
                'Eficiencia Clínica': random.choice(eficiencia_clinica),
                'Obsolescencia': random.choice(obsolescencia),
                'Costos': random.choice(costos),
                'Mantenimiento': random.choice(mantenimiento),
                'Riesgo al Paciente': random.choice(riesgo_paciente),
                'Dificultad para el Centro': random.choice(dificultad_centro),
                'Disponibilidad de Soporte': random.choice(disponibilidad_soporte),
                'Ubicación': f'Ubicación {random.randint(1, 10)}',
                'Costo Reparaciones': round(random.uniform(50, 500), 2),
                'Tiempo Uptime (hrs)': uptime,
                'Tiempo Downtime (hrs)': downtime_val, # Se usa el valor de la función
                'Costo Soles': costo
            })
            codigo += 1
            if codigo > cantidad_equipos:
                break
        if codigo > cantidad_equipos:
            break
